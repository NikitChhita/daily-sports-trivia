...
const StreakModal = () => {
    ...
    // account creation date — can't go back further than this
    ...
    const getDayStatus = (day) => {
        ...
        if (isBeforeAccount) return 'future' // grey out days before account
        ...
        <div className="streak-panel">
            ...
            <div className="streak-footer">
                ...
                <div className="streak-stat">
                    ...
                    <div className="streak-stat-value">
                        <span>🏆</span>
                        <span>{stats?.longest_streak || 0} days</span>
                    </div>
                </div>
            </div>
        </div>
