...
const Quiz = () => {
  ...
  useEffect(() => {
    const fetchQuiz = async () => {
      try {
        const res = await fetch("https://api.daily-sports-trivia.com/quiz/today");
  ...
  const handleOptionClick = async (option) => {
    if (submitted) return;
    try {
      const res = await fetch("https://api.daily-sports-trivia.com/quiz/answer", {
        method: "POST",
  ...
  const handleNext = async () => {
    ...
    if (isLastQuestion) {
      try {
        await fetch("https://api.daily-sports-trivia.com/quiz/submit", {
          method: "POST",
          headers: {
